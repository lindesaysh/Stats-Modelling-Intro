...
SHINY - Adjusting the centre and spread in a histogram. 
...
+ The 25th and 75th percentiles from the five number summary are  `r t1[2]` and `r t1[4]` and from the box plot are`r tx[2]` and `r tx[4]`. PERHAPS NEED TO CHANGE THIS.
